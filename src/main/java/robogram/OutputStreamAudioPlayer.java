...
/**
 * Streams audio to an {@link OutputStream}.
 */
public class OutputStreamAudioPlayer implements AudioPlayer {
	 ...
	 * 
	 */
	public OutputStreamAudioPlayer(OutputStream out, AudioFileFormat.Type type) {
		this.out = out;
		this.outputType = type;
		this.outputList = new Vector<InputStream>();

	}

	/**
	 * Creates a default audio player for an AudioFileFormat of type WAVE. Reads
	 * the "com.sun.speech.freetts.AudioPlayer.baseName" property for the base
	 * filename to use, and will produce a file of the form &lt;baseName>.wav.
	 * The default value for the base name is "freetts".
	 */
	public OutputStreamAudioPlayer(OutputStream out) {
	...
	public synchronized void close() {
		...
		try {
			...
			System.out.println("Wrote synthesized speech to output stream");
			AudioSystem.write(ais, outputType, out);
		} catch (IOException ioe) {
			System.err.println("Can't write audio to output stream");
